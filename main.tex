...
\begin{titlepage} % Suppresses displaying the page number on the title page and the subsequent page counts as page 1
	...
	\textsc{\LARGE Universität Augsburg}\\[1.5cm] % Main heading such as the name of your university/college
	
	\textsc{\Large Institut für Software- und Systems\\[0.2cm] Engineering}\\[0.5cm] % Major heading such as course name
	
	\textsc{\large Seminararbeit}\\[0.5cm] % Minor heading such as course title
	...
	{\huge\bfseries Formale Verifikation von C\\[0.2cm] Programmen}\\[0.4cm] % Title of your document
...
\noindent
Über die VeriFast IDE (siehe \vref{fig:vfide}) können Quellcodedateien modifiziert und Programmpfade einzelner Funktionen schrittweise ausgeführt werden. Im Falle eines Fehlers werden diese innerhalb des Editors lokalisiert und dem Benutzer über ein Statusfeld mitgeteilt.
